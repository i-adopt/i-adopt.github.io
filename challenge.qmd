...
<div style="text-align: center">
  **The SECOND Challenge is active and will still run for ...** 

<iframe src="https://free.timeanddate.com/countdown/i9jkffc1/n187/cf11/cm0/cu4/ct0/cs1/ca0/co0/cr0/ss0/cac00f/cpcf00/pcfff/tcfff/fs100/szw448/szh189/iso2024-10-18T21:59:00" allowtransparency="true" frameborder="0" width="404" height="27"></iframe>
</div>

<div style="text-align: center">
## Winners of the I-ADOPT Variable Modeling Challenge (First Challenge)
</div>
...
using the same ([participation and submission rules](material/I-ADOPT Challenge Rules - presentation version.pdf){target="_blank"}).
However, this time we will select 10 from the 30 variables that had the greatest variance in modeling. 
...
We have put valid models of the other 20 variables from the first challenge in the ([examples repository](https://github.com/i-adopt/examples){target="_blank"}) so that participants can use them for inspiration and reference. Be aware that other models might also be fulfilling the criteria. 

*limited to a maximum of 100 Euro for each participant.
