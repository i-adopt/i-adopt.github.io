...
We have put valid models of the other 20 variables from the first challenge in the ([examples repository](https://i-adopt.github.io/examples/){target="_blank"}) so that participants can use them for inspiration and reference. Be aware that other models might also be fulfilling the criteria. 
