...
The Challenge will take place in the week from the 12th to the 18th of September 2024.
...
::: {layout="[ 50, 50 ]"}
::: {#first-column}
![](img/piF%20logo_400kb%20JPEG.png){width="40%"}
:::

::: {#second-column}
![](img/mabablue_logo.png){width="80%"}
:::

::: {#third-column}
![](img/GFF logo (1).png){width="50%"}
:::
:::

More sponsors are needed. Please join GO FAIR Foundation, mabablue and partners in FAIR to support this Challenge. The deadlines is August 18.

::: centered-content
[**Support this Challenge**](https://docs.google.com/forms/d/e/1FAIpQLSdiDC3lLJpPqlK6080Wp3iPKKdDrEA5_HTz2_IiLW2rj8t7fQ/viewform){.btn .btn-action-primary .btn-action .btn-success .btn-lg role="button" target="_blank"}
:::
...
| September 13     | Subscription to the Challenge closed                                               |
