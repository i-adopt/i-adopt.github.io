...
1. An introduction to the I-ADOPT Framework ([presentation](material/I-ADOPT Framework - presentation version.pdf))

2. A step-by-step guide for creating an I-ADOPT compliant variable description ([presentation](material/I-ADOPT - Step by Step - presentation version.pdf))
...
::: {layout="[ 50, 50 ]"}
::: {#first-column}
[![](img/piF%20logo_400kb%20JPEG.png){width="40%}](https://partnersinfair.com/)
:::

::: {#second-column}
[![](img/mabablue_logo.png){width="80%"}](https://mabablue.com/)
:::

::: {#third-column}
[![](img/GFF logo (1).png){width="50%"}](https://www.gofair.foundation/)
:::
:::
