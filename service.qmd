...
format:
  html:
    css: service.css
title: The I-ADOPT Variable Annotation Service
author:
...
![](img/Logo.png){width="30%"}{target="_blank" style="display: block; text-align: center" }
...
2. Visualisation of the variable and human-in-the-loop functionality:
...
3. Integration with Research Platforms:
...
## Our Next Steps
* Develop [Variable Design Patterns](https://github.com/mabablue/I-ADOPT-patterns-playground/tree/main/pattern) to provide machine-readable decomposition design guidelines based on specific characteristics.
* Develop [Decision Trees](https://github.com/mabablue/I-ADOPT-patterns-playground/tree/main/Decisition_trees) for applying the Variable Design Patterns
* Enrich service with Patterns and Decision Trees following the instructions from the [Guideline](https://github.com/mabablue/I-ADOPT-patterns-playground/blob/main/Guide/guideline.md)
...
::: {layout="[ 40,60 ]"}
::: {#first-column}
[![](img/NFDI4Earth.jpg){width="5%"}](https://www.nfdi4earth.de/){target="_blank"}
:::

::: {#second-column}
[![](img/FAIR2Adapt.png){width="20%"}](https://fair2adapt-eosc.eu/){target="_blank"}
:::
