...
### Invited domain experts are encouraged to study the following material in advance:
...
3. Instructions for preparing variable models to be evaluated ([Presentation](https://github.com/i-adopt/i-adopt.github.io/blob/main/material/Preparing%20your%20variables.pdf){target="_blank"})
